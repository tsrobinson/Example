...
# To measure time, call woth @time:
@time main()

#= To get Julia to run faster:
Run function on a small sample
This enables the compiler to understand the code quickly
Then re-run with full sample!
 =#
